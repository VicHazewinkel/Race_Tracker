...
class RaceParticipantTest {
    ...
    /*
    To check if the race progress updates correctly after the race finishes,
    you need to assert that when the race finishes, the current progress is set to 100
     */
    @Test
    fun raceParticipant_RaceFinished_ProgressUpdated() = runTest {
        ...
        advanceTimeBy(raceParticipant.currentProgress * raceParticipant.progressDelayMillis)
